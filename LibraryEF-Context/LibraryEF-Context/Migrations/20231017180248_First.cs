        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOut = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 17, 22, 2, 48, 97, DateTimeKind.Local).AddTicks(6135)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Book = table.Column<int>(type: "int", nullable: false),
                    Id_Lib = table.Column<int>(type: "int", nullable: false),
                    DateOut = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 17, 22, 2, 48, 97, DateTimeKind.Local).AddTicks(57)),
                    DateIn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
